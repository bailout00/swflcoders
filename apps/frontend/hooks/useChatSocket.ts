...
import { Message, ChatMessage, chatMessageToMessage } from '../types/chat'
...
export function useChatSocket(options: UseChatSocketOptions = {}): UseChatSocketReturn {
  ...
  const attemptReconnect = useCallback(() => {
    ...
    console.log(`Attempting reconnect ${reconnectAttemptsRef.current}/${maxReconnectAttempts} in ${backoffDelay}ms`)
